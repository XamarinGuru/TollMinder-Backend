...
(function (a, b) {
  function G(a) {
    ...
    var e;if (p.isArray(b)) p.each(b, function (b, e) {
      c || cd.test(a) ? d(a, e) : ch(a + "[" + ((typeof e === "undefined" ? "undefined" : (0, _typeof3.default)(e)) == "object" ? b : "") + "]", e, c, d);
    ...
    a = typeof a == "string" ? F[a] || G(a) : p.extend({}, a);var c,
      ...
      var b = [["resolve", "done", p.Callbacks("once memory"), "resolved"], ["reject", "fail", p.Callbacks("once memory"), "rejected"], ["notify", "progress", p.Callbacks("memory")]],
          ...
          return (typeof a === "undefined" ? "undefined" : (0, _typeof3.default)(a)) == "object" ? p.extend(a, d) : d;
        } },
    ...
    function bd(a, b, c, d) {
      ...
      return a.appendChild(h.createComment("")), a.getElementsByTagName("*").length === 0;
        ...
        X = T(function (a) {
      return a.innerHTML = "<a href='#'></a>", a.firstChild && (0, _typeof3.default)(a.firstChild.getAttribute) !== j && a.firstChild.getAttribute("href") === "#";
    }),
        Y = T(function (a) {
      ...
      c = c || [], b = b || h;var e,
        ...
        $ = Z.selectors = { cacheLength: 50, match: L, order: ["ID", "TAG"], attrHandle: {}, createPseudo: Q, find: { ID: g ? function (a, b, c) {
          if ((0, _typeof3.default)(b.getElementById) !== j && !c) {
            var d = b.getElementById(a);return d && d.parentNode ? [d] : [];
          }
        } : function (a, c, d) {
          if ((0, _typeof3.default)(c.getElementById) !== j && !d) {
            var e = c.getElementById(a);return e ? e.id === a || (0, _typeof3.default)(e.getAttributeNode) !== j && e.getAttributeNode("id").value === a ? [e] : b : [];
          }
        }, TAG: W ? function (a, b) {
          if ((0, _typeof3.default)(b.getElementsByTagName) !== j) return b.getElementsByTagName(a);
        } : function (a, b) {
          ...
          return a = a.replace(K, ""), function (b) {
            var c = (0, _typeof3.default)(b.getAttributeNode) !== j && b.getAttributeNode("id");return c && c.value === a;
          };
        }, TAG: function TAG(a) {
          return a === "*" ? function () {
            return !0;
          ...
          var b = M[a];return b || (b = M[a] = new RegExp("(^|" + r + ")" + a + "(" + r + "|$)"), N.push(a), N.length > $.cacheLength && delete M[N.shift()]), function (a) {
            return b.test(a.className || (0, _typeof3.default)(a.getAttribute) !== j && a.getAttribute("class") || "");
          };
      ...
      if ((0, _typeof3.default)(b.getElementsByName) !== j) return b.getElementsByName(a);
    }), Y && ($.order.splice(1, 0, "CLASS"), $.find.CLASS = function (a, b, c) {
      if ((0, _typeof3.default)(b.getElementsByClassName) !== j && !c) return b.getElementsByClassName(a);
    });try {
    ...
    var a, b;p.uaMatch = function (a) {
      ...
      if (!a || a.nodeType === 3 || a.nodeType === 8 || !a.style) return;var f,
          ...
          h,
          i = p.camelCase(c),
          j = a.style;c = p.cssProps[i] || (p.cssProps[i] = bX(j, i)), h = p.cssHooks[c] || p.cssHooks[i];if (d === b) return h && "get" in h && (f = h.get(a, !1, e)) !== b ? f : j[c];g = typeof d === "undefined" ? "undefined" : (0, _typeof3.default)(d), g === "string" && (f = bQ.exec(d)) && (d = (f[1] + 1) * f[2] + parseFloat(p.css(a, c)), g = "number");if (d == null || g === "number" && isNaN(d)) return;g === "number" && !p.cssNumber[i] && (d += "px");if (!h || !("set" in h) || (d = h.set(a, d, e)) !== b) try {
        j[c] = d;
      } catch (k) {}
    ...
    if (typeof a != "string" && ct) return ct.apply(this, arguments);if (!this.length) return this;var e,
        ...
        g,
        h = this,
        i = a.indexOf(" ");return i >= 0 && (e = a.slice(i, a.length), a = a.slice(0, i)), p.isFunction(c) ? (d = c, c = b) : (typeof c === "undefined" ? "undefined" : (0, _typeof3.default)(c)) == "object" && (f = "POST"), p.ajax({ url: a, type: f, dataType: "html", data: c, complete: function complete(a, b) {
